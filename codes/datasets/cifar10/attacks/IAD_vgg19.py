...
schedule = {
    ...
    'experiment_name': 'cifar10_vgg19_IAD'
}
...
def get_config():
    config = {}
    # backdoor model
    backdoor_model = VGG("VGG19") # input shape:(1,32,32,3)
    # 加载backdoor权重
...
def attack():
    ...
    work_dir = "/data/mml/backdoor_detect/experiments/cifar10_vgg19_IAD_2023-12-06_13:25:53"
    dict_state = torch.load(os.path.join(work_dir, "dict_state.pth"), map_location="cpu")
