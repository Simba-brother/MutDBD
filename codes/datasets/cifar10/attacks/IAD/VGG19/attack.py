...
def create_backdoor_data():
    # create
    dict_state_file_path = os.path.join(exp_root_dir, "ATTACK", dataset_name, model_name, attack_name, "ATTACK_2024-12-18_13:20:48", "dict_state.pth")
    dict_state = torch.load(dict_state_file_path, map_location="cpu")
...
if __name__ == "__main__":
    proctitle = "CREATE|"+dataset_name+"|"+model_name+"|"+attack_name
