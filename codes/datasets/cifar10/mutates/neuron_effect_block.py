...
mutation_ratio = 0.05
mutation_num = 50
work_dir = f"/data/mml/backdoor_detect/experiments/CIFAR10/resnet18_nopretrain_32_32_3/mutates/neuron_effect_block/ratio_{mutation_ratio}_num_{mutation_num}/{attack_method}"
# 保存变异模型权重
save_dir = work_dir
