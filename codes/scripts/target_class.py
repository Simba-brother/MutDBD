...
def get_classes_precision_with_dif_mutation_rate_by_mutation_name(mutation_name):
    '''
...
def get_classes_precision_with_dif_mutation_rates_by_hybrid_mutator():
    '''
    ...
    assert len(data_dic[0.01][0]) == 50*mutated_operator_num, "数量不对"
    return data_dic

def get_target_class_with_dif_mutation_rate(data_dic):
    '''
    data_dic:
...
def get_pValue_Ciff_with_dif_mutation_rate(data_dict_1, data_dict_2):
    '''
        data_dict_1:
...
def get_AdaptiveRate_and_TargetClass(data_dict):
    '''
    data_dict:
        数据结构：{mutation_rate:{
                    "target_class_i":target_class_idx,
...
def get_target_class_by_mutation_name(mutation_name):
    '''
    获得该变异算子下, 不同变异率下 > target class
    '''
    ans_dict_1 = get_classes_precision_with_dif_mutation_rate_by_mutation_name(mutation_name)
    ans_dict_2 = get_target_class_with_dif_mutation_rate(ans_dict_1)
    return ans_dict_2

def get_target_class_by_hybrid_mutator():
    # 获得所有变异算子混合后，不同变异率下 > target_class
    ans_dict_1 = get_classes_precision_with_dif_mutation_rates_by_hybrid_mutator()
    ans_dict_2 = get_target_class_with_dif_mutation_rate(ans_dict_1)
    print(ans_dict_2)

def get_adaptive_rate_of_Hybrid_mutator():
    '''
    得到混合变异算子，自适应变异率
    Return:
    ...
    '''
    data_dic_1 = get_classes_precision_with_dif_mutation_rates_by_hybrid_mutator()
    data_dic_2 = get_target_class_with_dif_mutation_rate(data_dic_1)
    ans_dict_3 = get_pValue_Ciff_with_dif_mutation_rate(data_dic_1, data_dic_2)
    adaptive_rate, target_class_i = get_AdaptiveRate_and_TargetClass(ans_dict_3)
    data_dict_4 = {"adaptive_rate":adaptive_rate,  "target_class_i":target_class_i}
...
def get_adaptive_ratio_of_Combin_mutator():
    '''
    ...
    ans = {}
    for mutation_name in mutation_name_list:
        dict_1 = get_classes_precision_with_dif_mutation_rate_by_mutation_name(mutation_name)
        dict_2 = get_target_class_with_dif_mutation_rate(dict_1)
        dict_3 = get_pValue_Ciff_with_dif_mutation_rate(dict_1, dict_2)
        adaptive_rate, target_class_i = get_AdaptiveRate_and_TargetClass(dict_3)
        if adaptive_rate == -1:
