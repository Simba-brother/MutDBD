...
# BadNets
from datasets.poisoned_folder.badnets_folder import PoisonedDatasetFolder as BadNetsDataset
# IAD
from datasets.poisoned_folder.iad_folder import PoisonedDatasetFolder as IADDataset
from attack.core.attacks.IAD import Generator
# Refool
from datasets.poisoned_folder.refool_folder import PoisonedDatasetFolder as RefoolDataset
from attack.refool_util import get_reflection_images
# WaNet
from datasets.poisoned_folder.wanet_folder import PoisonedDatasetFolder as WaNetDataset
...
def look_ImageNet():
    ...
    # IAD
    backdoor_data = get_backdoor_data(dataset_name,model_name,"BadNets")
